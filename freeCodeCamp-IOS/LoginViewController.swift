...
class LoginViewController: UIViewController {
    ...
    func addBottomBorderToView(view: UIView, height: CGFloat, width: CGFloat, borderColor: UIColor) {
        let border = CALayer()
    ...
    private func setupTextFields() {
        ...
        addBottomBorderToView(view: emailTextField, height: height, width: width, borderColor: Stylesheet.Colors.white)
        addBottomBorderToView(view: passwordTextField, height: height, width: width, borderColor: Stylesheet.Colors.white)
        addBottomBorderToView(view: passwordConfirmTextField, height: height, width: width, borderColor: Stylesheet.Colors.white)
        addBottomBorderToView(view: firstNameTextField, height: height, width: width, borderColor: Stylesheet.Colors.white)
        addBottomBorderToView(view: lastNameTextField, height: height, width: width, borderColor: Stylesheet.Colors.white)
        
        emailTextField.placeholder = L10n.emailAddressPlaceholder
        emailTextField.setPlaceHolderTextColor(Stylesheet.Colors.white)
        emailTextField.textColor = Stylesheet.Colors.white
        emailTextField.autocorrectionType = .no
        emailTextField.autocapitalizationType = .none
        
        passwordTextField.placeholder = L10n.passwordPlaceholder
        passwordTextField.setPlaceHolderTextColor(Stylesheet.Colors.white)
        ...
        passwordConfirmTextField.setPlaceHolderTextColor(Stylesheet.Colors.white)
        ...
        firstNameTextField.setPlaceHolderTextColor(Stylesheet.Colors.white)
        ...
        lastNameTextField.setPlaceHolderTextColor(Stylesheet.Colors.white)
    ...
    private func setupButtons() {
        ...
        loginButton.setTitleColor(Stylesheet.Colors.secondaryColor, for: .normal)
        loginButton.setBackgroundColor(color: Stylesheet.Colors.white, forState: .normal)
        ...
        cancelButton.setTitleColor(Stylesheet.Colors.secondaryColor, for: .normal)
        cancelButton.setBackgroundColor(color: Stylesheet.Colors.white, forState: .normal)
        ...
        signUpButton.setTitleColor(Stylesheet.Colors.secondaryColor, for: .normal)
        signUpButton.setBackgroundColor(color: Stylesheet.Colors.white, forState: .normal)
